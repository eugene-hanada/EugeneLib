...
EugeneLib::Dx12ShaderResourceViews::Dx12ShaderResourceViews(Graphics& graphics, size_t size) :
	Dx12Views{graphics,size,true,D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV}, ShaderResourceViews{size}
{
}
