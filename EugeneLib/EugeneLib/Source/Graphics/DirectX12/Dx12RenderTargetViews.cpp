...
EugeneLib::Dx12RenderTargetViews::Dx12RenderTargetViews(Graphics& graphics, size_t size, bool isShaderVisible) :
	Dx12Views{graphics,size, isShaderVisible, D3D12_DESCRIPTOR_HEAP_TYPE_RTV },
