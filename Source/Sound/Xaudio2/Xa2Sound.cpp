...
{
	return new Xa2SoundSpeaker{xaudio2_.Get(),soundFile, sound_.inChannel_, maxPitchRate};
}
...
{
	return new Xa2SoundStreamSpeaker{xaudio2_.Get(), path, sound_.outChannel_, maxPitchRate };
}
