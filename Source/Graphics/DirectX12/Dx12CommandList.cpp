...
void Eugene::Dx12CommandList::SetRenderTarget(RenderTargetViews& renderTargetViews,
...
void Eugene::Dx12CommandList::CopyBuffer(BufferResource& dest, BufferResource& src)
{
